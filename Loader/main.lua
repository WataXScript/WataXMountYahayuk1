...
local saveFile = "WataX_Key_Yahayuk.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXScript/WataXMountYahayuk1/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountYahayuk1/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountYahayuk1/main/Loader/mainmap970.lua"))()
end
